var wordDictionary = ["bench", "car", "bus", "chair"]; // Will require a list of valid words that can be accepted by the game board 
...
console.log(validTilePlacement("lens", fstPos, letPos, dirV, board));
console.log(board);

console.log(validTilePlacement("plan", sndPos, letPos, dirV, board));
